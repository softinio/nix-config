...
local config = {
  ...
  keys = {
    ...
    { key = 'n', mods = 'LEADER', action = wezterm.action { ActivatePaneDirection = 'Right' } },
    { key = 'd', mods = 'LEADER|CTRL', action = wezterm.action { AdjustPaneSize = { 'Left', 5 } } },
    { key = 'h', mods = 'LEADER|CTRL', action = wezterm.action { AdjustPaneSize = { 'Down', 5 } } },
    { key = 't', mods = 'LEADER|CTRL', action = wezterm.action { AdjustPaneSize = { 'Up', 5 } } },
    { key = 'n', mods = 'LEADER|CTRL', action = wezterm.action { AdjustPaneSize = { 'Right', 5 } } },

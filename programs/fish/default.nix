...

{
  ...
  programs.fish = {
    ...
    shellInitLast = ''
      ...
      set -xg PATH $HOME/bin $HOME/.local/bin $HOME/.cargo/bin $HOME/.npm-global/bin /Users/salar/.luarocks/bin:/Users/salar/bin:/Users/salar/.nix-profile/bin:/nix/var/nix/profiles/default/bin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin "/Applications/IntelliJ IDEA.app/Contents/MacOS" /Applications/WezTerm.app/Contents/MacOS /Applications/Obsidian.app/Contents/MacOS $PATH
